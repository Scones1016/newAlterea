      ...
      <div className="container">
        <div className="card cardBeforeYouBegin">
          ...
          <p className="text mt-4">
            ...
            Before we proceed, we need to perform an analysis of your personality, in order to put you into the training environments <span className="highlight">best suited to you.</span> Our handy algorithm is here to help: sit back, relax, and let the answer flow as naturally from you as possible! <br></br>
            <span className="highlight">No math, no fuss, you have our word!</span>
          </p>
