export default [
	{
		question: "It's the day of the mission and your driver arrives in 30 minutes. Time to get out of bed and put on spy gear, like the real spy you are. What’ll it be?",
	...
	},
	{
		...
		messages: ["He steps closer, sneering at you. Suddenly the doors open and you dash out, just beyond his outstretched arm. He follows, but you deliver a well-placed kick to his stomach, knocking him back into the elevator as the doors close. ", "You drop into a crouch as he throws his first punch! His hand slams into the wall right where your head should have been. You duck under his next punch, then counter with a well-placed elbow to his chin. He drops cold. You open the doors and exit to the hallway."]
	},
	{
		...
		messages: ["You slide into the alcove, making yourself as inconspicuous as possible. As you settle into your position, you don’t notice a figure slowly emerging from the shadows behind you...BAM! You crumple to the floor. ", "This is a great idea in theory. Unfortunately, you’re too distracted by your passing reflection in a mirror to notice the guard approaching from behind...BAM! You crumple to the floor. "]
	},
	{
		question: "When you wake up you're bound to a table under harsh light. Dr. Disinfo emerges from the darkness, clapping slowly. “Well done...well done, agent! I knew it was only a matter of time before you showed up. For I am irresistible! Unobtainable! Indigestible!” After a moment he nods confidently to himself. How do you respond?",
		...
		messages: ["He lets out an evil — and clearly well-rehearsed — laugh. “Mwah-hah-hah-hah...hah...hah... You think you can fool me, agent? Think again.”", "The smile falls off his face, replaced with a sneer. “Very well, agent. I see we will need to do this the hard way.”", "He blushes slightly. “You know, agent, despite all the times you’ve meddled with my plans I always thought we had a chance.” He shakes his head. “But I know better than to fall for your tricks one more time.”", "“Don’t think I didn’t see that!” Disinfo exclaims. He takes the watch off your wrist and puts it in his pocket, shaking his head in disappointment."]
	},
	{
	...
	},
	{
		...
		answers: ["> Climb into the vent system.", "> Break a window and rappel down the side of the building.", "> Take the elevator reading “DR. DISINFO’S PRIVATE ESCAPE ROUTE, DON’T USE UNLESS YOU’RE DR. DISINFO.", "> Go find the henchman you knocked out: you need a disguise."],
	...
	},
	{
		...
		answers: ["> Yes", "> No"],
		messages: ["With a winning smirk, you look straight at Dr. Disinfo and press the button. A rumble. You can feel the vehicle transforming around you. “NO!” Dr. Disinfo screams, holding even tighter to the hood. Wings slide out on either side of the car. The wheels fold in, locking into position as the vehicle rises off the ground just a few inches. You floor it. Dr. Disinfo loses his grip and you shoot into the sunset, leaving Disinfo a tiny speck on the ground below. ", "You smirk at Dr. Disinfo and slam on the gas. Your vehicle screeches out of the hotel roundabout, swerving left and right to shake him off. Bit by bit, he slips off until he’s just hanging on by his fingertips. “This is just the beginning!” he says, just before  falling off the hood. You peel out into traffic, leaving Dr. Disinfo behind, screaming on the pavement."]
	}
